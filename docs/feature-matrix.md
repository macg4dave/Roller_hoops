...
| UI discovery runs explorer (Phase 12) | Discovery run list, detail, and logs views backed by Phase 9 discovery APIs plus real-time failure/status signals | ui-node | (calls Go API) | none | in-progress |
